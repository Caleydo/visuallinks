...
//       void       SetVerticesOut(int nVerticesOut);                 //!< Set the maximal number of vertices the geometry shader can output
      ...
      bool       setUniform1ui(const GLcharARB* varname, GLuint v0, GLint index = -1); //!< Specify value of uniform unsigned integer variable. Only works if GL_EXT_gpu_shader4 is available. \param varname The name of the uniform variable.
      bool       setUniform2ui(const GLcharARB* varname, GLuint v0, GLuint v1, GLint index = -1); //!< Specify value of uniform unsigned integer variable. Only works if GL_EXT_gpu_shader4 is available. \param varname The name of the uniform variable.
      bool       setUniform3ui(const GLcharARB* varname, GLuint v0, GLuint v1, GLuint v2, GLint index = -1); //!< Specify value of uniform unsigned integer variable. Only works if GL_EXT_gpu_shader4 is available. \param varname The name of the uniform variable.
      bool       setUniform4ui(const GLcharARB* varname, GLuint v0, GLuint v1, GLuint v2, GLuint v3, GLint index = -1); //!< Specify value of uniform unsigned integer variable. Only works if GL_EXT_gpu_shader4 is available. \param varname The name of the uniform variable.
      ...
      void       getUniformuiv(const GLcharARB* varname, GLuint* values, GLint index = -1); //!< Receive value of uniform variable. Requires GL_EXT_gpu_shader4 \param varname The name of the uniform variable.
