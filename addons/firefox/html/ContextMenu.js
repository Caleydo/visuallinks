...
ContextMenu.prototype.onAdd=function(){
	function createMenuItem(values){
		...
		menuItem.onclick=function(){
			google.maps.event.trigger($this, 'menu_item_selected', $this.position_, values.eventName, values.value);
		};
		return menuItem;
	}
...
ContextMenu.prototype.show=function(latLng, customEntries){
	if(!this.isVisible_){
